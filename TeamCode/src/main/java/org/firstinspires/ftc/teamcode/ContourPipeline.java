...
public class ContourPipeline extends OpenCvPipeline {
    Scalar HOT_PINK = new Scalar(255, 127, 22);

    // Pink, the default color                         Y      Cr     Cb    (Do not change Y)
    public static Scalar scalarLowerYCrCb = new Scalar(1, 160, 70);
    public static Scalar scalarUpperYCrCb = new Scalar(245, 255.0, 120.0);
