...
@Autonomous(name="OpenCV_Blue_2A", group="Tutorials")

public class blue_opencv_2a extends LinearOpMode {
    /*    public static Scalar scalarLowerYCrCb = new Scalar(1, 170, 70);
    public static Scalar scalarUpperYCrCb = new Scalar(70, 255.0, 180.0);
    ...
    public static Scalar scalarLowerYCrCb = new Scalar(20, 100.0, 150.0);
    public static Scalar scalarUpperYCrCb = new Scalar(145, 150.0, 255.0);
